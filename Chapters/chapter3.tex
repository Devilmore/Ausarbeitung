...
\caption{Determining the meeting point for a linear path part \cite{12} \label{pic:meeting_point_linear}}
\end{figure}
...
\caption{Determining the meeting point for a circular path part \cite{12} \label{pic:meeting_point_circle}}
\end{figure}
